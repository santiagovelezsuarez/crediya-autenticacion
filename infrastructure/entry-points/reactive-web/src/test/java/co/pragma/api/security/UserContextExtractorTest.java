...
class UserContextExtractorTest {
    ...
    void fromRequestShouldExtractHeadersAndParsePermissions() {
        ...
        assertTrue(userContext.permissionEnums().contains(PermissionEnum.REGISTRAR_USUARIO));
    }
    ...
    private void mockHeaders() {
        ...
        when(headers.firstHeader("x-user-permissions")).thenReturn("REGISTRAR_USUARIO");
    }
}
